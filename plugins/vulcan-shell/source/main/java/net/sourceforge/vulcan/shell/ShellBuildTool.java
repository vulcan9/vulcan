...
public class ShellBuildTool implements BuildTool {
	private final ShellBuildToolConfig globalConfig;
	private final ShellProjectConfig projectConfig;

	public ShellBuildTool(ShellBuildToolConfig globalConfig, ShellProjectConfig projectConfig) {
	...
	public void buildProject(ProjectConfigDto projectConfig,
		...
		throw new BuildFailedException("Not implemented.", null, 0);
	}
