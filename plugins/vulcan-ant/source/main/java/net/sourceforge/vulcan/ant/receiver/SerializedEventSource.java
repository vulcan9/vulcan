...
public abstract class SerializedEventSource extends AbstractEventSource {
	...
	public SerializedEventSource(Serializer serializer) {
		this.serializer = serializer;
	}

	protected final AntEventSummary deserialize(final byte[] data) throws IOException, ClassNotFoundException {
