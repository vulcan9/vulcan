...
public class MercurialRepositoryTest extends EasyMockTestCase {
	...
	public void testGetChangeLogEmptyNullDiffStream() throws Exception {
		invoker.invoke("log", workDir, "--style", "xml", "--verbose", "-r", "::456 and not(::123)");
	...
	public void testGetChangeLogEmptyFormatsRevision() throws Exception {
		invoker.invoke("log", workDir, "--style", "xml", "--verbose", "-r", "::1123458 and not(::1123456)");
		returnSuccessWithOutput("<log/>");
	...
	public void testGetChangeLogDiff() throws Exception {
		...
		invoker.invoke("log", workDir, "--style", "xml", "--verbose", "-r", "::2 and not(::1)");
		returnSuccessWithOutput("<log/>");
