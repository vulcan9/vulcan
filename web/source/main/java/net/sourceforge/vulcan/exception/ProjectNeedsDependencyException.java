...
public final class ProjectNeedsDependencyException extends Exception {
	final String projectToDelete;
	final String dependantProject;

	public ProjectNeedsDependencyException(
			final String projectToDelete,
			final String dependantProject) {
		this.projectToDelete = projectToDelete;
		this.dependantProject = dependantProject;
	}
	public String getDependantProject() {
		return dependantProject;
	}
	...
	public Object[] getArgs() {
		return new Object[] {dependantProject, projectToDelete};
	}
}
