...
public class StubPlugin implements BuildManagerObserverPlugin {
	public String getId() {
		return "com.example";
	}
	public String getName() {
		return "Stdout Plugin";
	}
	public void onBuildCompleted(BuildCompletedEvent event) {
		System.out.println(event.getProjectConfig().getName() + " - " + event.getStatus().isPass());
	}
}
