...
class DependencyFailureException extends DependencyException {
	...
	DependencyFailureException(final ProjectConfigDto projectConfig,
			final String dependencyName) {
		super();
	...
	public String getKey() {
		return "messages.dependency.failure";
	}
	public Object[] getArgs() {
		return new Object[] {projectConfig.getName(), dependencyName};
	}
}
